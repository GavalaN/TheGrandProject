...
INSERT INTO `cars` (`id`, `brand_id`, `pic_id`, `type_id`, `description`, `km_clock`, `color_id`, `price`, `seller_id`, `upload_date`, `sold`, `body_type`, `num_of_cyl`, `horsepower`, `cc`, `engine_type`, `fuel_type`, `drive`, `trans_type`, `Year`, `k_weight`) VALUES
(1, 1, 1, 1, 'Fuel-efficient and reliable.', 40000, 3, 18000, 1, '2024-01-10 10:00:00', 0, 'Sedan', 4, 139, 1798, 'Inline', 'Petrol', 'FWD', 'Automatic', 2022, 1400),
(2, 2, 1, 2, 'Comfortable and spacious.', 25000, 2, 25000, 1, '2024-02-05 14:30:00', 0, 'Sedan', 4, 192, 1996, 'Inline', 'Petrol', 'FWD', 'CVT', 2021, 1500),
(3, 3, 1, 3, 'Strong and powerful SUV.', 60000, 5, 32000, 1, '2023-12-01 09:45:00', 1, 'SUV', 6, 400, 3000, 'V', 'Petrol', 'AWD', 'Automatic', 2023, 2100),
(4, 4, 1, 4, 'Eladó sorba került BMW 320i autóm!\r\nAmit tudni kell róla:\r\n2006 év\r\nPopsnBangs\r\nSzakadás mentes beltér.\r\nM lökhárítók, M felni, M kormány.\r\nAngel Eyes.\r\nM3 visszapillantók.\r\nMűködő Klíma.\r\nVétel ár: 1,800,000ft\r\nCsere érdekelhet, kisebb-nagyobb \r\nautóra!', 20000, 1, 42000, 1, '2024-03-15 16:20:00', 0, 'Coupe', 6, 382, 2998, 'Inline', 'Petrol', 'RWD', 'Automatic', 2022, 1700),
(5, 5, 1, 5, 'Luxury and performance.', 18000, 4, 48000, 1, '2023-11-20 08:10:00', 1, 'Sedan', 4, 255, 1991, 'Inline', 'Petrol', 'RWD', 'Automatic', 2023, 1800),
(6, 6, 1, 6, 'Large family-friendly SUV.', 55000, 6, 35000, 1, '2024-01-25 12:50:00', 0, 'SUV', 8, 420, 5300, 'V', 'Petrol', 'AWD', 'Automatic', 2021, 2500),
(7, 7, 1, 7, 'Efficient and compact.', 30000, 7, 19000, 1, '2024-02-20 11:15:00', 0, 'Sedan', 4, 149, 1997, 'Inline', 'Petrol', 'FWD', 'CVT', 2020, 1300),
(8, 8, 1, 8, 'Reliable mid-size sedan.', 75000, 8, 22000, 1, '2023-10-10 07:35:00', 1, 'Sedan', 4, 174, 1984, 'Inline', 'Petrol', 'FWD', 'Manual', 2019, 1400),
(13, 1, 1, 1, 'A nice car', 50000, 1, 15000, 1, '2025-02-24 11:43:38', 0, 'Sedan', 4, 150, 2000, 'Inline', 'Petrol', 'FWD', 'Automatic', 2020, 1500);
...
(3, 3, 'Ford Explorer'),
(4, 4, 'BMW 3 Series'),
(5, 5, 'Mercedes C-Class'),
(6, 6, 'Chevrolet Tahoe'),
(7, 7, 'Nissan Sentra'),
(8, 8, 'Volkswagen Passat');
