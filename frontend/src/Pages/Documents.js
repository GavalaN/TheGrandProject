...
import nemet_magyar_adasveteli from '../Documents/Egyszerusitett-nemet-magyar-adasveteli.pdf'
...
export default function Documents() {
  return (
    <div className="etc">
        ...
        <hr/>
        <h4>Német - magyar adásvételi szerződés</h4>
        <p>A német - magyar adásvételi szerződés mintát (ha szívatni akarod magad) megtekintheti és letöltheti <Link to={nemet_magyar_adasveteli} target='_blank'>Itt</Link>.</p>
        <hr/>
